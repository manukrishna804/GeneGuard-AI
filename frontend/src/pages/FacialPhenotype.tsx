export default function FacialPhenotype() {
  return (
    <div className="flex flex-col gap-6 h-full pb-10">
      <div className="flex items-center gap-2">
        <h1 className="text-3xl font-bold text-gray-900">Facial Phenotype</h1>
      ...
      <p className="text-gray-500">Rule-based facial landmark screening</p>
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col flex-1 items-center justify-center p-8 text-center min-h-[400px]">
        ...
        <p className="text-sm text-gray-500 max-w-md">
          This feature will use MediaPipe landmark measurement against published anthropometric ratios. It is currently planned for future development and not yet implemented.
        </p>
      </div>
    </div>
  );
